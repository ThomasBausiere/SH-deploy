...
Dans **Guild Wars** (NCsoft), un titre/succès consiste à **capturer 300 compétences élites** disséminées aux quatre coins du monde, détenues par des **boss élites**. Les joueurs doivent trouver puis éliminer ces boss pour **capturer** chaque compétence.
