...
Dans **Guild Wars** (NCsoft), un titre/succès consiste à **capturer 300 compétences élites** disséminées aux quatre coins du monde, détenues par des **Boss**. Les joueurs doivent donc traquer puis éliminer ces boss pour **capturer** chaque compétence.
